...
// AERIAL_OCUDU P7 L2->L1: translate OCUDU-FAPI data-plane messages (DL_TTI / UL_TTI /
// UL_DCI / TX_DATA) into SCF FAPI and send them to Aerial over nvIPC.

#ifndef AERIAL_L1_OCUDU_OAI_L2_TO_L1_P7_H
#define AERIAL_L1_OCUDU_OAI_L2_TO_L1_P7_H
...
int aerial_l2l1_tx_data_request(struct AppContext* ctx,
                               const uint8_t* body, uint32_t body_len);
...
#endif /* AERIAL_OCUDU */
#endif /* AERIAL_L1_OCUDU_OAI_L2_TO_L1_P7_H */
