...
// OCUDU FAPI wire format (hand-rolled, pure C) for the OAI_OCUDU bridge:
...
#ifndef OAI_L1_OCUDU_OCUDU_FAPI_WIRE_H
#define OAI_L1_OCUDU_OCUDU_FAPI_WIRE_H
...
#endif /* OAI_OCUDU */
#endif /* OAI_L1_OCUDU_OCUDU_FAPI_WIRE_H */
